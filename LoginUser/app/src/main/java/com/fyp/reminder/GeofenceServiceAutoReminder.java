...
public class GeofenceServiceAutoReminder extends IntentService {

    private static final String TAG = GeofenceTrasitionService.class.getSimpleName();

    public static int GEOFENCE_NOTIFICATION_ID;
    private static final String CHANNEL_ID = "geofence_auto_id" ;

    public GeofenceServiceAutoReminder() {
        super(TAG);
    }
...
//        PendingIntent notificationPendingIntent = stackBuilder.getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private Notification createNotification(String msg, String locationName) {
        ...
        PendingIntent actionIntent = PendingIntent.getBroadcast(getApplicationContext(),requestcode,action,0);
