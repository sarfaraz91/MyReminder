...
public class GoogleApiUrl {
    ...
    public static final String API_KEY = "AIzaSyDB0DPGWwF75AhY5by1fuZ_RlCD-xtWsJo";
    ...
    public static String Place_Name = "HBL";
