...
public class PlaceDetailProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (matchPlaceUri) {
            case PLACE:
                cursor = placeDetailDatabase.query(PlaceDetailContract.PlaceDetailEntry.PLACE_TABLE_NAME,
                        projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case PLACE_ID:
                selection = PlaceDetailContract.PlaceDetailEntry._ID + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                cursor = placeDetailDatabase.query(PlaceDetailContract.PlaceDetailEntry.PLACE_TABLE_NAME, projection,
    ...
    private Uri insertPlaceDetails(Uri uri, ContentValues values) {
        ...
        long id = placeDetailDatabase.insert(PlaceDetailContract.PlaceDetailEntry.PLACE_TABLE_NAME, null, values);
        if (id == -1) {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (matchPlaceUri) {
            case PLACE:
                ...
                rowDeleted = placeDetailDatabase.delete(PlaceDetailContract.PlaceDetailEntry.PLACE_TABLE_NAME,
